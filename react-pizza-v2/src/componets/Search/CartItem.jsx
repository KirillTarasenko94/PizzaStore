...
import { addProduct, removeItem, minusItem} from '../../redux/slice/cartSlice';

function CartItem({id, title, price, imageUrl, count}) {
  ...
  return (
    ...
    <div className="cart__item">
      ...
      <div className="cart__item-remove">
        <div onClick={onCickClear} className="button button--outline button--circle">
          <svg
            width="10"
            height="10"
            viewBox="0 0 10 10"
